...
class LocalTranscriptionService: TranscriptionService {
    ...
    func transcribe(audioURL: URL, model: any TranscriptionModel) async throws -> String {
        return try await transcribe(audioURL: audioURL, model: model, onProgress: nil, onNewSegment: nil)
    }
    
    func transcribe(audioURL: URL, model: any TranscriptionModel, onProgress: ((Double) -> Void)?) async throws -> String {
        return try await transcribe(audioURL: audioURL, model: model, onProgress: onProgress, onNewSegment: nil)
    }
    
    func transcribe(audioURL: URL, model: any TranscriptionModel, onProgress: ((Double) -> Void)?, onNewSegment: ((String) -> Void)?) async throws -> String {
        ...
        await whisperContext.fullTranscribe(samples: data, onProgress: onProgress, onNewSegment: onNewSegment)
