...
#ifndef VOICEINK_SWIFT_H
#define VOICEINK_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="VoiceInk",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC8VoiceInk11AppDelegate")
...
SWIFT_CLASS("_TtC8VoiceInk12KeyablePanel")
...
SWIFT_CLASS("_TtC8VoiceInk17MiniRecorderPanel")
@interface MiniRecorderPanel : NSPanel
@property (nonatomic, readonly) BOOL canBecomeKeyWindow;
@property (nonatomic, readonly) BOOL canBecomeMainWindow;
...
SWIFT_CLASS("_TtC8VoiceInk18NotchRecorderPanel")
@interface NotchRecorderPanel : KeyablePanel
@property (nonatomic, readonly) BOOL canBecomeKeyWindow;
@property (nonatomic, readonly) BOOL canBecomeMainWindow;
- (nonnull instancetype)initWithContentRect:(NSRect)contentRect styleMask:(NSWindowStyleMask)style backing:(NSBackingStoreType)backingStoreType defer:(BOOL)flag SWIFT_UNAVAILABLE;
@end
...
SWIFT_CLASS("_TtC8VoiceInk12WhisperState")
@interface WhisperState : NSObject <AVAudioRecorderDelegate>
...
@interface WhisperState (SWIFT_EXTENSION(VoiceInk))
- (void)handleToggleMiniRecorder;
- (void)handleLicenseStatusChanged;
- (void)handlePromptChange;
@end

SWIFT_CLASS("_TtC8VoiceInk14WindowDelegate")
...
SWIFT_CLASS("_TtC8VoiceInk19WindowStateDelegate")
@interface WindowStateDelegate : NSObject <NSWindowDelegate>
- (void)windowWillClose:(NSNotification * _Nonnull)notification;
